...
export function Trigger() {
    ...
    return (
        <label
            htmlFor={id}
            className="group flex-1 cursor-pointer flex-col flex items-center gap-3 rounded-lg border border-zinc-300 dark:border-zinc-800 px-6 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-violet-300"
        >
            ...
            <div className="flex flex-col items-center gap-1">
                <span className="text-sm">
                    <span className="font-semibold text-violet-700 dark:text-violet-300">Click to upload</span> or drag
                    and drop
                </span>
